...
let g:atp_maps = [['execute', 'nmap <buffer> ', 'g:atp_map_forward_motion_leader', 'i', ':NInput<CR>"'], 
	    ...
	    \ ['execute', 'vnoremap <buffer> ', 'g:atp_vmap_text_font_leader', 'rm', ':<C-U>IWrap [''\\textrm{''],[''\\mathrm{'']<CR>"'], 
	    \ ['execute', 'vnoremap <buffer> ', 'g:atp_vmap_text_font_leader', 'em', ':<C-U>IWrap [''\\emph{''],[''\\mathit{'']<CR>"'], 
	    \ ['execute', 'vnoremap <buffer> ', 'g:atp_vmap_text_font_leader', 'it', ':<C-U>IWrap [''\\textit{''],[''\\mathit{'']<CR>"'], 
	    \ ['execute', 'vnoremap <buffer> ', 'g:atp_vmap_text_font_leader', 'sf', ':<C-U>IWrap [''\\textsf{''],[''\\mathsf{'']<CR>"'], 
	    \ ['execute', 'vnoremap <buffer> ', 'g:atp_vmap_text_font_leader', 'tt', ':<C-U>IWrap [''\\texttt{''],[''\\mathtt{'']<CR>"'], ['execute', 'vnoremap <buffer> ', 'g:atp_vmap_text_font_leader', 'bf', ':<C-U>InteligentWrapSelection [''\\textbf{''],[''\\mathbf{'']<CR>"'], 
	    \ ['execute', 'vnoremap <buffer> ', 'g:atp_vmap_text_font_leader', 'bb', ':<C-U>IWrap [''\\textbf{''],[''\\mathbb{'']<CR>"'], ['execute', 'vnoremap <buffer> ', 'g:atp_vmap_text_font_leader', 'sl', ':<C-U>WrapSelection ''\\textsl{''<CR>"'], 
	    ...
	    \ ['execute', 'vnoremap <buffer> ', 'g:atp_vmap_text_font_leader', 'ov', ':<C-U>WrapSelection ''\\overline{''<CR>"'], ['execute', 'vnoremap <buffer> ', 'g:atp_vmap_text_font_leader', 'no', ':<C-U>IWrap [''\\textnormal{''],[''\\mathnormal{'']<CR>"'], 
	    \ ['execute', 'vnoremap <buffer> ', 'g:atp_vmap_text_font_leader', 'cal', ':<C-U>IWrap [''''],[''\\mathcal{'']<CR>"'], ['execute', 'vnoremap <buffer> ', 'g:atp_vmap_environment_leader', 'C', ':WrapSelection ''"."\\"."begin{center}'',''"."\\"."end{center}'',''0'',''1''<CR>"'], 
