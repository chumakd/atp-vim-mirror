...
parser.add_option("-r", "--runs",       dest="runs",            default=1,             type="int",      help="how many times run tex consecutively")
...
parser.add_option("-k", "--keep",       dest="keep",            default="aux,toc,bbl,ind,pdfsync,synctex.gz",                                                    help="comma separated list of extensions (see :help g:keep in vim)")
...
parser.add_option("--gui-running",      action="store_true",   default=False,  dest="gui_running",     help="if vim gui is running (has('gui_running'))")
